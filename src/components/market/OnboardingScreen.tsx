  ...
  return (
    <div className="fixed inset-0 z-[300] bg-[var(--mp-bg)]">
      ...
      <div className="relative z-10 h-[100dvh] flex flex-col items-center justify-between px-6 pt-10 pb-10 w-full max-w-[430px] mx-auto">
        ...
        {/* Content */}
        <div className="flex-1 flex flex-col justify-center w-full max-w-[340px] overflow-hidden">
              ...
              >
                <div className="mp-glass rounded-[32px] p-6 mb-6 shadow-[0_40px_80px_rgba(0,0,0,0.8)] relative overflow-hidden group w-full">
                  ...
                  <div className="relative z-10">
                    ...
                    <h3 className="text-[24px] font-black leading-tight pb-1 mb-3 mp-gradient-text animate-gradient-x">{t.future}</h3>
                ...
                <div className="mp-glass rounded-[32px] p-6 mb-3 shadow-[0_40px_80px_rgba(0,0,0,0.8)] relative overflow-hidden w-full">
                  ...
                  <div className="space-y-2">
                    ...
                    <motion.button
                      ...
                      whileTap={{ scale: 0.98 }}
                      onClick={onLogin}
                      className="w-full bg-foreground text-background font-black py-3 rounded-[16px] text-[12px] uppercase tracking-widest shadow-2xl"
                    >
                      {t.emailLogin}
                    </motion.button>
                    <button
            ...
            {showLanguageMenu && (
              <>
                <motion.div
                  ...
                  className="fixed inset-0 z-[311]"
                />
                <motion.div
                  initial={{ opacity: 0, y: 10, scale: 0.95 }}
                  animate={{ opacity: 1, y: 0, scale: 1 }}
                  exit={{ opacity: 0, y: 10, scale: 0.95 }}
                  className="absolute bottom-full mb-3 left-1/2 -translate-x-1/2 w-[280px] bg-[#0D0E14] border border-white/[0.1] rounded-2xl p-3 shadow-[0_-10px_50px_rgba(0,0,0,0.8)] z-[312] grid grid-cols-2 gap-1.5"
                >
