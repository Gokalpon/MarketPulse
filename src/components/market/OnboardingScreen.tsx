          ...
          <AnimatePresence mode="wait">
            {onboardingStep === 0 ? (
              ...
              >
                ...
                {/* GET STARTED — 3D depth button */}
                <motion.button
                  onClick={handleGetStarted}
                  className="relative overflow-visible py-[18px] px-10 rounded-full text-[13px] font-black uppercase tracking-[0.22em]"
                  style={{
                  ...
                  whileHover={!filling ? {
                    boxShadow: "0 12px 48px rgba(0,0,0,0.5), 0 0px 20px rgba(0,255,135,0.2)",
                  ...
                  animate={filling ? {
                    boxShadow: "0 0px 0px rgba(0,0,0,0.1), 0 0px 40px rgba(0,255,135,0.6)",
                    transform: "translateZ(0px)"
                  } : {}}
                >
                  {/* Smooth fill — liquid gradient */}
                  <motion.div
                    className="absolute inset-0 rounded-full pointer-events-none"
                    initial={{ opacity: 0 }}
                    animate={filling ? { opacity: 1 } : { opacity: 0 }}
                    transition={{ duration: 0.6, ease: "easeOut" }}
                    style={{
                      background: "linear-gradient(135deg, #00FF87 0%, #00E5CC 100%)",
                      filter: "blur(1px)"
                    }}
                  />
                  ...
                  <motion.span
                    ...
                    initial={{ opacity: 1 }}
                    animate={filling ? { opacity: 0 } : { opacity: 1 }}
                  ...
                  <motion.div
                    ...
                    animate={filling ? { opacity: 1, scale: 1 } : { opacity: 0, scale: 0 }}
                    transition={{ duration: 0.4, delay: 0.2 }}
                    onAnimationComplete={() => { if (filling) { setFilling(false); setOnboardingStep(1); } }}
                  >
                    <svg className="w-6 h-6 text-[#040D08]" fill="currentColor" viewBox="0 0 24 24">
